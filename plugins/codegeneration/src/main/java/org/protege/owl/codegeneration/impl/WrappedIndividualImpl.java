...
public class WrappedIndividualImpl implements WrappedIndividual {
     ...
     * @param owlOntology
     */
    public WrappedIndividualImpl(OWLOntology owlOntology, IRI iri, CodeGenerationInference inf) {
        this(owlOntology, owlOntology.getOWLOntologyManager().getOWLDataFactory().getOWLNamedIndividual(iri), inf);
    }
    
    public WrappedIndividualImpl(OWLOntology owlOntology, OWLNamedIndividual owlIndividual, CodeGenerationInference inf) {
        this.owlOntology = owlOntology;
        this.owlIndividual = owlIndividual;
        this.inference = inf;
        delegate = new CodeGenerationHelper(owlOntology, owlIndividual, this.inference);
    }
