...
public enum CodeGenerationPhase {
	...
	CREATE_DATA_PROPERTY_INTERFACE("interface.data.property"),
        CREATE_FUNCTIONAL_OBJECT_PROPERTY_INTERFACE("interface.functionalobject.property"),
	CREATE_FUNCTIONAL_DATA_PROPERTY_INTERFACE("interface.functionaldata.property"),
	...
	CREATE_FUNCTIONAL_OBJECT_PROPERTY_IMPLEMENTATION("implementation.functionalobject.property"),
	CREATE_FUNCTIONAL_DATA_PROPERTY_IMPLEMENTATION("implementation.functionaldata.property"),
