...
public interface CodeGenerationInference {
	...
	Collection<OWLClass> getTypes(OWLNamedIndividual i);
        ...
        Collection<? extends OWLIndividual> getObjectPropertyValues(OWLNamedIndividual i, OWLObjectPropertyExpression p);

        Collection<OWLLiteral> getDataPropertyValues(OWLNamedIndividual i, OWLDataProperty p);
