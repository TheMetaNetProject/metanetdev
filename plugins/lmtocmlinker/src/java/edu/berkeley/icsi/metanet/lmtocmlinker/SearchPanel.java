...
public class SearchPanel extends JPanel {
    ...
    private JPanel searchFilterColumn() {
        ...
        searchFilter.setMaximumSize(new Dimension(300,600));
...
//		list = new EntityList(owlModel, library, "LinguisticMetaphor");
        ...
        selectedList.setMaximumSize(new Dimension(300,200));
        SelectButtons selectButtons = new SelectButtons();
        selectButtons.setAlignmentX(Component.LEFT_ALIGNMENT);
