<?php
/**
 * MetaNet Public Site-wide Configuration Settings
 *
 */
...
# Triplestore settings - user default SQL store for public wiki
...
# recent changes maximum age: 1 year
$wgRCMaxAge = 86400 * 365.242 * 1;
