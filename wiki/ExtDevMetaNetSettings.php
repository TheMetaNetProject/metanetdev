...
# Default permissions for anonymous users: no access
...
# Allow logged in users read privilege (see other user privileges at bottom)
$wgGroupPermissions['user']['read']             = true;

# Create an analyst group but do not give edit access so that
# one will not accidentally make changes here that get clobbered
$wgGroupPermissions['analyst'] = $wgGroupPermissions['user'];
$wgGroupPermissions['analyst']['createaccount'] = true;
$wgGroupPermissions['analyst']['edit'] = false;
$wgGroupPermissions['analyst']['move'] = false;
$wgGroupPermissions['analyst']['delete'] = false;
$wgGroupPermissions['analyst']['undelete']= true;
$wgGroupPermissions['analyst']['rollback']= false;
$wgGroupPermissions['analyst']['patrol']= true;
$wgGroupPermissions['analyst']['suppressredirect'] = false;
...
# Don't let analysts create accounts, since they need to be made
# on internal wiki.
$wgWhitelistAccount = array ( 'user' => 0, 'analyst' => 1, 'sysop' => 1,
			      'developer' => 1 );
...
# Buffalo cannot run a triplestore server
...
# recent changes maximum age: 5 years
$wgRCMaxAge = 86400 * 365.242 * 5;
