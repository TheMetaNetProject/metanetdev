...
def main():
	...
	if args['type'].lower() == 'json':
		...
		f = open(original_dir+args['file'], 'r', encoding='utf-8')
		...
		arguments = {'file': 'verbObj.txt', 'language': 'russian', 'rel_type': 'verb-object', 'seeds_list': '/u/metanet/extraction/seeds/ru/verb-obj.ei', 'output_file_name': None}
		...
		arguments['seeds_list'] = '/u/metanet/extraction/seeds/ru/subj-verb.ei'
		discovered_metaphors = search_metaphors(arguments)
		...
		json.dump(input_file, output, sort_keys=True, indent=2,
                  ensure_ascii=False)
		output.close()
		f.close()	
