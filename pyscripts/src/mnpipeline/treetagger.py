...
.. module: treetagger
    :platform: Unix
    :synopsis: NLTK interface to TreeTagger
    
Natural Language Toolkit: Interface to the TreeTagger POS-tagger
A Python module for interfacing with the Treetagger by Helmut Schmid via NLTK.
Copyright (C) Mirko Otto

.. moduleauthor:: Mirko Otto <dropsy@gmail.com>
...
u'utf8' : ['english','french', 'german', 'greek', 'italian', 'spanish','russian']}
...
class TreeTagger(TaggerI):
    ...
    def __init__(self, path_to_home=None, language='german', 
        ...
        """
        treetagger_paths = ['/u/metanet/nlptools/tree-tagger-3.2/bin',
                            '/u/metanet/nlptools/tree-tagger-3.2/cmd',
                            '~/metanet/nlptools/tree-tagger-3.2/bin',
                            '~/metanet/nlptools/tree-tagger-3.2/cmd',
                            '/usr/bin',
                            '/usr/local/bin',
                            '/opt/local/bin',
