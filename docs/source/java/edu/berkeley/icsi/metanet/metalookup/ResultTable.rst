...
.. java:type:: public class ResultTable extends JSplitPane
...
.. java:constructor::  ResultTable()
   :outertype: ResultTable

ResultTable
^^^^^^^^^^^

.. java:constructor::  ResultTable(OWLOntology owlModel, MetaNetFactory mfact, SearchPanelListItem items, EntityLibrary library, HashMap<String, Set<String>> frames)
   :outertype: ResultTable
